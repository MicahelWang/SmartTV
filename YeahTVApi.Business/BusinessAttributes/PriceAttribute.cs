...
{
    public class PriceAttribute : BusinessAttribute
    {
        /// <summary>
        /// 设置源需要做反序列化的对象类型
        /// </summary>
        ...
        public PriceAttribute()
            : base(typeof(CentralApiResult<HZTVApi.Entity.CentralMapping.ReceiveOrdersResult>))
        {
        ...
        public override Object ConvertTo(String json, Guest guest)
        {
            ...
            if (result == null)
                return null;
            var data = result as CentralApiResult<HZTVApi.Entity.CentralMapping.ReceiveOrdersResult>;
            if (data == null)
                return null;
