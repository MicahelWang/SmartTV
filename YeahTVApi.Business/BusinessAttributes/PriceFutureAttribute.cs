...
{
    public class PriceFutureAttribute : BusinessAttribute
    {
        /// <summary>
        /// 设置源需要做反序列化的对象类型
        /// </summary>
        /// <param name="sourceType"></param>
        public PriceFutureAttribute()
            : base(typeof(CentralApiResult<HZTVApi.Entity.CentralMapping.ReceiveOrderPriceResult>))
        {
        ...
        public override Object ConvertTo(String json, Guest guest)
        {
            ...
            if (result == null)
                return null;
            var data = result as CentralApiResult<HZTVApi.Entity.CentralMapping.ReceiveOrderPriceResult>;
            if (data == null)
                return null;
