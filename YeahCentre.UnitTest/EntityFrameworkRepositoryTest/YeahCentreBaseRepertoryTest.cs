...
{
    [TestClass]
    public class YeahCentreBaseRepertoryTest<TEntity, Key> where TEntity : BaseEntity<Key>, new()
    {
        ...
        public void Setup()
        {
            EFUnitOfWork.Current = new EFUnitOfWork(new YeahCentre.EntityFrameworkRepository.YeahCentreContext());
