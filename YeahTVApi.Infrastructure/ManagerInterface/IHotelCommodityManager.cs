...
namespace YeahTVApi.Infrastructure
{
    ...
    public interface IHotelCommodityManager
    {
        /// <summary>
        /// 获取酒店可售小商品列表
        /// 参数：酒店ID
        ...
        /// </summary> 
        Tuple<Dictionary<string, List<HotelCommodityEntity>>, List<HotelCommodityCategoryEntity>> GetProductListByHotelId(string hotelID);
        /// <summary>
        ///提交小商品订单
