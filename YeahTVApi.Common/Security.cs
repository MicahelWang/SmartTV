...
namespace YeahTVApi.Common
{
    ...
    public static class Security
    {
        ...
        private static readonly string EncryptKey = AppSettings.GetString("EncryptKey", "yeahInfo");
        public static string ToPassWordString(this string source)
        {
            return EncryptDes(source, EncryptKey);
        }
