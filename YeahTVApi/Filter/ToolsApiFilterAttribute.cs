    ...
    public class ToolsApiFilterAttribute : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            if (fmt != ApiResultFormat.debug)
            {
                ...
                {
                    HTOutputLog.SaveError(this.GetType().Name, err, data);
        ...
        public override void OnResultExecuted(ResultExecutedContext filterContext)
        {
            ...
            if (filterContext.Result is ApiResult)
            {
                ...
                WebApiCommon.writenResponse(filterContext.HttpContext, apiResult, fmt);
                //记录输出日志内容
                HTOutputLog.SaveInfo("  Response Result: ", apiResult.ToJsonString());           
            }           
            ...
            if (HttpContext.Current.Items.Contains("START_TIME"))
            {
                ...
                HTOutputLog.SaveInfo(HttpContext.Current.Request.Url.ToString(), "耗时:" + span.TotalSeconds);
            }
